...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		//Menu from user
				...
				switch(ch) {
				case 1: StudentInfoOperations.displayStudentInfo();
				        break;
				case 2: StudentInfoOperations.insertStudentInfo();
				        break;
				case 3: StudentInfoOperations.updateStudentInfo(); 
				         break;
				case 4:StudentInfoOperations.deleteStudentInfo();
				         break;
				case 5: StudentInfoOperations.selectStudentInfo();
				         break;
